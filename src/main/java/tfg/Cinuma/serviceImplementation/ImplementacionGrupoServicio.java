 ...
 */
@Service
public class ImplementacionGrupoServicio implements GrupoServicio{
    ...
    @Override
    public Grupo findByGrupoId(String grupoId) {
        return grupoRepository.findByGrupoId(grupoId);
    }

    @Override
    public void deleteGrupoByGrupoId(String grupoId) {
        grupoRepository.deleteGrupoByGrupoId(grupoId);
    }
